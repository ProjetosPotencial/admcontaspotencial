        ...
        <div className="space-y-4">
          {itens.map((item) => (
            item.classe_documento === "nota_fiscal" ? (
              <NotaFiscalCard key={item.id} item={item} lojas={lojas} processando={processando === item.id} onConfirmarNF={confirmarNF} onRejeitar={rejeitar} />
            ) : (
...
function NotaFiscalCard({ item, lojas, processando, onConfirmarNF, onRejeitar }: {
