  ...
  return (
    <>
      <div className="px-8 py-8">
        ...
        <p className="text-[14px] text-[#666] mt-2.5">Como o sistema decide o que precisa de aprovação, e quem pode aprovar</p>
      </div>
        ...
        {REGRAS.map((r) => (
          <div key={r.tipo} className="card p-5 flex gap-4 items-start">
            ...
            <div>
              ...
              <p className="text-[13px] text-[#666] mt-1 leading-relaxed">{r.desc}</p>
              <div className="text-[12px] text-[#999] mt-2">Quem aprova: <b className="text-[#1a1a1a] font-medium">{r.quem}</b></div>
            </div>
          </div>
        ))}
        <div className="text-[12px] text-[#999] bg-[#f5f5f5] rounded-md px-4 py-3 leading-relaxed">
