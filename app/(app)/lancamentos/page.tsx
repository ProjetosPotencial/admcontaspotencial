...
export default async function LancamentosPage() {
  ...
  const [{ data }, { data: mesAtualDetalhado }] = await Promise.all([
    supabase
      .from("lancamentos")
      .select("id, ano, mes, valor, situacao, comprovante_url, comprovante_drive_url, codigo_barras, aprovado_por, aprovado_em, contas!inner ( tipo, dia_vencimento, fornecedor_nome, lojas ( codigo, coban ) )")
      .eq("ano", ano)
